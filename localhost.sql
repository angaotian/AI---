...
('demo-member-1', 'demo-user-id', '张三', '父亲', 58, '男', '#8b5cf6', 85, '中', '2026-03-28', NULL, NULL),
('demo-member-2', 'demo-user-id', '李四', '母亲', 56, '女', '#f97316', 88, '中', '2026-03-28', NULL, NULL),
('demo-member-3', 'demo-user-id', '王五', '配偶', 32, '男', '#22c55e', 95, '低', '2026-03-28', NULL, NULL),
('member-1775531331945', 'demo-user-id', '李子昂', '其他', 20, '男', '#3b82f6', 88, '低', '2026-04-07', NULL, NULL),
('member-1775531465271', 'demo-user-id', '刘译泽', '其他', 18, '男', '#3b82f6', 88, '低', '2026-04-07', NULL, NULL),
('member-1775531488743', 'demo-user-id', '雷德宏', '其他', 17, '男', '#3b82f6', 88, '低', '2026-04-07', NULL, NULL),
('member-1775531552026', 'demo-user-id', '付为红', '其他', 18, '男', '#3b82f6', 88, '低', '2026-04-07', NULL, NULL),
('member-1775531648786', 'demo-user-id', '陶志豪', '其他', 19, '男', '#3b82f6', 88, '低', '2026-04-07', NULL, NULL);
...
('msg-1774710646038-1', 'demo-user-id', '每日健康提醒', '记得按时测量血压和心率', '完整内容：建议您每天早上起床后测量血压和心率，并记录下来。', 'health', 'normal', 0, NULL),
('msg-1774710646039-2', 'demo-user-id', '系统更新通知', '系统已升级到 v2.3.0', '完整内容：本次更新优化了数据可视化效果，修复了已知问题。', 'system', 'low', 0, NULL),
('msg-1774710646041-3', 'demo-user-id', '心率异常提醒', '检测到您的心率偏高', '完整内容：您今天下午的心率持续高于正常范围，建议适当休息。', 'health', 'high', 0, NULL);

-- --------------------------------------------------------

--
-- 表的结构 `multimodal_records`
--
...
('mm-1775034198936', 'demo-user-id', '中性', 0.99, '平静', 7, 1313, 75, 98, '良好', 'camera_voice', '2026-04-01 09:03:18', NULL, NULL, NULL, NULL),
('mm-1775037468437', 'demo-user-id', '开心', 0.9695, '平静', 2, 47, 78, 98, '良好', 'camera_voice', '2026-04-01 09:57:48', NULL, NULL, NULL, NULL),
('mm-1775189603314', 'demo-user-id', '开心', 0.7747, '平静', 0, 0, 82, 98, '良好', 'camera_voice', '2026-04-03 04:13:23', NULL, NULL, NULL, NULL),
('mm-1775280083160', 'demo-user-id', '中性', 0.8304, '平静', 0, 0, 65, NULL, '良好', 'camera_voice', '2026-04-04 05:21:23', NULL, '女', 0.573, 19),
('mm-1775280153057', 'demo-user-id', '中性', 0.8639, '平静', 0, 0, 69, NULL, '良好', 'camera_voice', '2026-04-04 05:22:33', NULL, '女', 0.621, 17),
('mm-1775281577586', 'demo-user-id', '未检测', 0.9904, '平静', 0, 0, 65, NULL, '良好', 'camera_voice', '2026-04-04 05:46:17', NULL, '未知', 0.615, 0),
('mm-1775281624511', 'demo-user-id', '悲伤', 0.863, '平静', 0, 0, 68, NULL, '良好', 'camera_voice', '2026-04-04 05:47:04', NULL, '男', 0.9682, 20),
('mm-1775281659703', 'demo-user-id', '中性', 0.7512, '平静', 0, 0, 63, NULL, '良好', 'camera_voice', '2026-04-04 05:47:39', NULL, '女', 0.6288, 18),
('mm-1775467347302', 'demo-user-id', '中性', 0.9633, '平静', 1, 47, 67, NULL, '良好', 'camera_voice', '2026-04-06 09:22:27', NULL, '男', 0.9743, 18),
('mm-1775468249692', 'demo-user-id', '中性', 0.9829, '平静', 1, 35, 75, NULL, '良好', 'camera_voice', '2026-04-06 09:37:29', NULL, '男', 0.8046, 19),
('mm-1775469130126', 'demo-user-id', '中性', 0.772, '平静', 1, 4500, 73, NULL, '良好', 'camera_voice', '2026-04-06 09:52:10', NULL, '男', 0.8257, 19),
('mm-1775469221768', 'demo-user-id', '中性', 0.6516, '低落', 23, 47, 70, NULL, '良好', 'camera_voice', '2026-04-06 09:53:41', NULL, '男', 0.8468, 18),
('mm-1775531411983', 'demo-user-id', '中性', 0.4619, '平静', 0, 0, 67, NULL, '良好', 'camera_voice', '2026-04-07 03:10:11', NULL, '男', 0.8559, 18),
('mm-1775531418770', 'demo-user-id', '中性', 0.795, '平静', 0, 0, 67, NULL, '良好', 'camera_voice', '2026-04-07 03:10:18', NULL, '男', 0.9105, 17),
('mm-1775531420922', 'demo-user-id', '中性', 0.9463, '平静', 0, 0, 76, NULL, '良好', 'camera_voice', '2026-04-07 03:10:20', NULL, '男', 0.8622, 18),
('mm-1775531622852', 'demo-user-id', '中性', 0.9647, '平静', 0, 0, 73, NULL, '良好', 'camera_voice', '2026-04-07 03:13:42', NULL, '男', 0.9348, 19),
('mm-1775558162694', 'demo-user-id', '中性', 0.9938, '平静', 0, 0, 76, NULL, '良好', 'camera_voice', '2026-04-07 10:36:02', NULL, '男', 0.978, 23);
...
('demo-user-id', 'demo', 'demo@health.com', '$2a$10$uAx5avbOmX6T9OVUe3DoyOOz7gSeOSa0yjdsduEr7rUxk.CJaIOqy', '演示用户', '13800138000', NULL, '2026-03-28', NULL, NULL);
...
(1, 1, '一位 WordPress 评论者', 'wapuu@wordpress.example', 'https://cn.wordpress.org/', '', '2024-12-11 14:15:29', '2024-12-11 06:15:29', '您好，这是一条评论。若需要审核、编辑或删除评论，请访问仪表盘的评论界面。评论者头像来自 <a href=\"https://cn.gravatar.com/\">Gravatar</a>。', 0, '1', '', 'comment', 0, 0);
...
(26, 'links_updated_date_format', 'Y年n月j日 H:i', 'on'),
...
(171, 'https_detection_errors', 'a:1:{s:20:\"https_request_failed\";a:1:{i:0;s:21:\"HTTPS 请求失败。\";}}', 'auto'),
